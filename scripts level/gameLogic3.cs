...
IEnumerator playNote(int counter,AudioSource C,AudioSource D,AudioSource E,AudioSource F,AudioSource G,AudioSource A,AudioSource B,int time){
    ...
    async void Start()
    {
        ...
        StartCoroutine(playNote(arr[6],SC,SD,SE,SF,SG,SA,SB,6));
           StartCoroutine(playNote(arr[7],SC,SD,SE,SF,SG,SA,SB,7));
              StartCoroutine(playNote(arr[8],SC,SD,SE,SF,SG,SA,SB,8));
                 StartCoroutine(playNote(arr[9],SC,SD,SE,SF,SG,SA,SB,9));
        Note.text = "";
